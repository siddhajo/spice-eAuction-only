...
keytool -genkeypair -v \
  ...
  -dname "CN=RNS Spices, O=RNS Spices, C=IN"
...
host (`https://rns-eauction.up.railway.app/mobile`).
...
2. Wait ~5–10 min. It installs, syncs, signs, builds, and **commits the APK into
   `public-mobile/downloads/spice-auction.apk`** — which triggers a Railway
   deploy.
3. That's it. The APK is now live at:
   **`https://rns-eauction.up.railway.app/mobile/install.html`**
