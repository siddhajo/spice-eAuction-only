...
Bluetooth printing must be tested on a **real Android phone** with the **MPT-II
...
- **Pair the MPT-II:** Settings → Bluetooth → pair the printer (Classic printers
...
1. Open the **Spice Auction** app.
2. Menu (⋮) → **Print method** → cycle to **Bluetooth (app)**.
3. Menu → **Connect Bluetooth printer** → pick the MPT-II.
